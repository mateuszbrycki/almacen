...
<div id="share-folder-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog" style="width: 600px">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close share-folder-form-close" data-dismiss="modal"
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="add-folder-modal-title"><spring:message code="folder.share"/></h4>
            </div>
            <div class="modal-body">
                <form id='folder-share-form' action="${pageContext.request.contextPath}<%=FolderUrls.FOLDER_SHARE_FORM%>"
