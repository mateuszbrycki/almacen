...
<div class="col-xs-12 col-md-8 col-md-offset-2">
    ...
    <%--<div class="panel panel-default">--%>
        ...
        <%--</div>--%>
        <%--<div class="panel-body">--%>
            <%--<form id='user-changerole-form' action="${pageContext.request.contextPath}<%=UserUrls.USER_CHANGE_ROLE_FORM%>" method='POST' class="form-horizontal">--%>
                <%--<div class="form-group">--%>
                ...
                <%--<input type="submit" id="username-changerole-user" name="submit" value="<spring:message code="button.save" />" class="btn btn-primary"/>--%>
            <%--</form>--%>
        <%--</div>--%>
    <%--</div>--%>
