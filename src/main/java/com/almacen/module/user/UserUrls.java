...
public class UserUrls implements UrlSpace {
    ...
    public static final String USER_EDIT_MANAGEMENT_ID = USER_EDIT_MANAGEMENT + "/{userId}";
    ...
    public static final String ADMIN_CHANGE_ROLE = USER_EDIT_MANAGEMENT + "/changerole";
    public static final String ADMIN_CHANGE_ROLE_FORM = USER + ADMIN_CHANGE_ROLE;
